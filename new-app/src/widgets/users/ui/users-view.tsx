...
import { EmployeeIcon, UserIcon } from "@/shared/assets";
...
import { useUserSearchParams } from "@/entities/user/lib";
...
export default function UsersView({
    ...
    const columns = useMemo(() => getUsersColumns({ roles: roleListItems }), [roleListItems]);
