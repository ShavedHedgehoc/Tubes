// type PostType = "extrusion" | "varnish" | "offset" | "sealant";
...
export type ParameterSummaryData = {
  isActive: boolean;
  isFinished: boolean;
  productCode: string;
  productName: string;
...
export type ExtrusionData = {
  summary: ParameterSummaryData;
  parameters: ExtrusionDataRaw;
  tresholds: Treshold;
  prev: number | null;
  next: number | null;
};

export type VarnishData = {
  summary: ParameterSummaryData;
  parameters: VarnishDataRaw;
  tresholds: Treshold;
  prev: number | null;
  next: number | null;
};
...
export type OffsetData = {
  summary: ParameterSummaryData;
  parameters: OffsetDataRaw;
  tresholds: Treshold;
  prev: number | null;
  next: number | null;
};

export type SealantData = {
  summary: ParameterSummaryData;
  parameters: SealantDataRaw;
  tresholds: Treshold;
  prev: number | null;
  next: number | null;
};

// Объединение для компонента ParameterDetails
export type AnyParameter =
  | { type: "extrusion"; data: ExtrusionData | null }
  | { type: "varnish"; data: VarnishData | null }
  | { type: "offset"; data: OffsetData | null }
  | { type: "sealant"; data: SealantData | null };
