...
export type PostType = "extrusion" | "varnish" | "offset" | "sealant"

// entities/parameter/model/types.ts
...
export type AnyParameter =
    ...
    | { type: "extrusion"; data: ExtrusionData }
    | { type: "varnish"; data: VarnishData }
    | { type: "offset"; data: OffsetData }
    | { type: "sealant"; data: SealantData };
