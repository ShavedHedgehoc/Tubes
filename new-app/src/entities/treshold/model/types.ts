...
export type TresholdUploadTableRow = {
    ...
    extrusion_tube_cilindrical_section_length_min: string;
    extrusion_tube_cilindrical_section_length_max: string;
    ...
    extrusion_tube_cilindrical_section_thickness_min: string;
    extrusion_tube_cilindrical_section_thickness_max: string;
