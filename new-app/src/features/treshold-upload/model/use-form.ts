...
import { ACCEPTED_FILE_TYPES, uploadTresholdsFormSchema, UploadTresholdsFormValues, useTresholdUiParams } from "@/entities/treshold";
...
export const useTresholdUploadForm = () => {
    ...
    async function onSubmit(data: UploadTresholdsFormValues) {
