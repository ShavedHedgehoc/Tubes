...
import { Button, Command, CommandEmpty, CommandGroup, CommandItem, CommandList, CommandSeparator, Popover, PopoverContent, PopoverTrigger } from "@/shared/ui";
import { Check, ChevronDown } from "lucide-react";
import { useCombobox } from "../model";
import { useState } from "react";

export function UserRolesCombobox({ user, roles }: { user: UserEntity; roles: RoleEntity[] }) {
    const [open, setOpen] = useState(false);
    const { selectedIds, isChanged, reset, onUpdate, onSelect } = useCombobox({ user })
