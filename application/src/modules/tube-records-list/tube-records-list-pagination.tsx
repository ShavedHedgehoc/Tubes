...
export default function TubeRecordsListPagination() {
  const paginationProps: PaginationProps = {
    ...
    total: useTubeRecordsListPaginationStore(
      useShallow((state) => state.total),
    ),
    limit: useTubeRecordsListPaginationStore(
      useShallow((state) => state.limit),
    ),
    increasePage: useTubeRecordsListPaginationStore(
      useShallow((state) => state.increasePage),
    ),
    decreasePage: useTubeRecordsListPaginationStore(
      useShallow((state) => state.decreasePage),
    ),
    setLimit: useTubeRecordsListPaginationStore(
      useShallow((state) => state.setLimit),
    ),
    setPage: useTubeRecordsListPaginationStore(
