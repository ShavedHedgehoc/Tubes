...
export default function TubeRecordsListFilterConveyorSelector() {
  const changeFilter = useTubeRecordsListFilterStore(
    useShallow((state) => state.changeFilter),
  );
  const selectedConveyorOption = useTubeRecordsListFilterStore(
