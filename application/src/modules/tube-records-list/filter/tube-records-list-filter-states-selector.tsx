...
export default function TubeRecordsListFilterStateSelector() {
  ...
  const selectedStateOption = useTubeRecordsListFilterStore(
    useShallow((state) => state.selectedStateOption),
  );
  const setSelectedStateOption = useTubeRecordsListFilterStore(
    useShallow((state) => state.setSelectedStateOption),
  );
