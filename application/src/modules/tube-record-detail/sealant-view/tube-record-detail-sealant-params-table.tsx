...
export default function TubeRecordDetailSealantParamsTable({
  ...
  const commonThead: TheadFullHeightProperties[] = [
    ...
    {
      width: 120,
      value: "Скорость колпачковой машины",
      align: "center",
      padding: "12px 24px",
    },
    {
    ...
    {
      width: 120,
      value: "Захваты вперед",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Открытие захваты (лев)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Открытие захваты (прав)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Закрытие захвата",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Начало впрыска А,B",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Конец впрыска А,B",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Положение тубы для впрыска (начало)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Положение тубы для впрыска (конец)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Поверхность колпачка гладкая, без царапин",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Отступ латексного кольца от края тубы",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Ширина латексного кольца",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Жесткость готовой тубы",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Измерение крутящего момента откручивания колпачка",
      align: "center",
      padding: "12px 24px",
    },
      ...
      {paramsData.length === 0 ? (
        ...
        <TableFullHeightLayout thead={commonThead}>
          {paramsData.map((row, index) => (
            <TubeRecordsDetailSealantParamsRow
              row={row}
              key={row.id}
              index={index}
            />
