...
export default function TubeRecordsDetailExtrusionParamsRow({
  row,
  index,
}: {
  ...
  return (
    <tr key={row.id}>
      ...
      <td style={{ width: 40, textAlign: "center", padding: "12px 24px" }}>
        <Typography level="body-xs">{row.press_speed}</Typography>
      </td>
      <td style={{ width: 40, textAlign: "center", padding: "12px 24px" }}>
        <Typography level="body-xs">{row.blow_time}</Typography>
      </td>
      <td style={{ width: 40, textAlign: "center", padding: "12px 24px" }}>
        <Typography level="body-xs">{row.turning_machine_speed}</Typography>
      </td>
      <td style={{ width: 40, textAlign: "center", padding: "12px 24px" }}>
        <Typography level="body-xs">{row.annealing_furnace_temp}</Typography>
      </td>
      <td style={{ width: 40, textAlign: "center", padding: "12px 24px" }}>
