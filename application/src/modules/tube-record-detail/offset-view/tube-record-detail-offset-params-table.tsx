...
export default function TubeRecordDetailOffsetParamsTable({
  ...
  const commonThead: TheadFullHeightProperties[] = [
    ...
    {
      width: 120,
      value: "Скорость принтовальной машины",
      align: "center",
      padding: "12px 24px",
    },
    {
    ...
    {
      width: 120,
      value: "Температура печи (грунтование)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Температура печи (печать)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Мотор принтера",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Мотор держателей баз. покрытий",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "1 печатный ящик (отпечатков)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "2 печатный ящик (отпечатков)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "3 печатный ящик (отпечатков)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "4 печатный ящик (отпечатков)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "5 печатный ящик (отпечатков)",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "6 печатный ящик (отпечатков)",
      align: "center",
      padding: "12px 24px",
    },
    ...
    {
      width: 120,
      value: "Мотор станции баз. покрытия",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Время подачи чернил",
      align: "center",
      padding: "12px 24px",
    },
    {
      width: 120,
      value: "Соответсвие дизайну и контрольному образцу",
      align: "center",
      padding: "12px 24px",
    },
    {
    ...
    {
      width: 120,
      value: "Отсутствие деформации края тубы",
      align: "center",
      padding: "12px 24px",
    },
    {
      ...
      {paramsData.length === 0 ? (
        ...
        <TableFullHeightLayout thead={commonThead}>
          {paramsData.map((row, index) => (
            <TubeRecordsDetailOffsetParamsRow
              row={row}
              key={row.id}
              index={index}
            />
