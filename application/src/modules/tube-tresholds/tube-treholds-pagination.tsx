...
export default function TubeTresholdsPagination() {
  const paginationProps: PaginationProps = {
    ...
    increasePage: useTubeTresholdsPaginationStore(
      useShallow((state) => state.increasePage),
    ),
    decreasePage: useTubeTresholdsPaginationStore(
      useShallow((state) => state.decreasePage),
    ),
    setLimit: useTubeTresholdsPaginationStore(
      useShallow((state) => state.setLimit),
    ),
    setPage: useTubeTresholdsPaginationStore(
