...
export enum ParameterNames {
  ...
  EXTRUSION_TUBE_CYLINDRICAL_SECTION_LENGTH = "Длина цилиндрической части тубы",
  EXTRUSION_MEMBRANE_THICKNESS = "Толщина мембраны",
  EXTRUSION_TUBE_DIAMETER = "Диаметр тубы",
  EXTRUSION_TUBE_CYLINDRICAL_THICKNESS = "Толщина цилиндрической части тубы",
  ...
  SEALANT_HOLDERS_CLOSING = "Закрытие захвата", //ед.
