...
export default function TubeEmployeesPagination() {
  const paginationProps: PaginationProps = {
    ...
    increasePage: useTubeEmployeesPaginationStore(
      useShallow((state) => state.increasePage),
    ),
    decreasePage: useTubeEmployeesPaginationStore(
      useShallow((state) => state.decreasePage),
    ),
    setLimit: useTubeEmployeesPaginationStore(
      useShallow((state) => state.setLimit),
    ),
    setPage: useTubeEmployeesPaginationStore(
