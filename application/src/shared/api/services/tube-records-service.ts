...
export interface TubeRecordDetailExtrusionTresholds {
  ...
  rondel_id: number;
  tube_cylindrical_section_length_min: number;
  tube_cylindrical_section_length_max: number;
  membrane_thickness_min: number;
  membrane_thickness_max: number;
  tube_diameter_min: number;
  tube_diameter_max: number;
  tube_cylindrical_section_thickness_min: number;
  tube_cylindrical_section_thickness_max: number;
