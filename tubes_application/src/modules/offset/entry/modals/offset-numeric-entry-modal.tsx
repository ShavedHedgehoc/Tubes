...
export default function OffsetNumericEntryModal() {
  const id = useOffsetNumericEntryModalStore(useShallow((state) => state.key));
  const title = useOffsetNumericEntryModalStore(useShallow((state) => state.title));
  const open = useOffsetNumericEntryModalStore(useShallow((state) => state.open));
  const setOpen = useOffsetNumericEntryModalStore(useShallow((state) => state.setOpen));
  const dataKey = useOffsetNumericEntryModalStore(useShallow((state) => state.key));
  const minValue = useOffsetNumericEntryModalStore(useShallow((state) => state.minValue));
  const maxValue = useOffsetNumericEntryModalStore(useShallow((state) => state.maxValue));
  const unit = useOffsetNumericEntryModalStore(useShallow((state) => state.unit));
