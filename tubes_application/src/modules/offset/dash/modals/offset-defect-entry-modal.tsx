...
export default function OffsetDefectEntryModal() {
  const open = useOffsetDefectInputModalStore(
    useShallow((state) => state.open),
  );
  const setOpen = useOffsetDefectInputModalStore(
  ...
  const roundData = useOffsetDefectStore(
    useShallow((state) => state.roundData),
  );
  const changeData = useOffsetDefectStore(
    useShallow((state) => state.changeData),
  );
  const sliceData = useOffsetDefectStore(
