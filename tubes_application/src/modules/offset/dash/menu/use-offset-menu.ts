...
export default function useOffsetMenu() {
  ...
  const handleOpenParametersClick = () => {
    ...
    setData({ key: OffsetInputParams.PRINTING_MACHINE_SPEED, value: printingMachineSpeed })
    setData({ key: OffsetInputParams.TOTAL_AIR_PRESSURE, value: totalAirPressure })
    setData({ key: OffsetInputParams.PRINTER_MOTOR, value: printerMotor })
    setData({ key: OffsetInputParams.BASE_COVERS_HOLDERS_MOTOR, value: baseCoversHoldersMotor })
    setData({ key: OffsetInputParams.BASE_COVERS_STATION_MOTOR, value: baseCoversStationMotor })
    setData({ key: OffsetInputParams.IMPRINT_QUANTITY_PRINTED_BOX_1, value: imprintQuantityPrintedBox1 })
    setData({ key: OffsetInputParams.IMPRINT_QUANTITY_PRINTED_BOX_2, value: imprintQuantityPrintedBox2 })
    setData({ key: OffsetInputParams.IMPRINT_QUANTITY_PRINTED_BOX_3, value: imprintQuantityPrintedBox3 })
    setData({ key: OffsetInputParams.IMPRINT_QUANTITY_PRINTED_BOX_4, value: imprintQuantityPrintedBox4 })
    setData({ key: OffsetInputParams.IMPRINT_QUANTITY_PRINTED_BOX_5, value: imprintQuantityPrintedBox5 })
    setData({ key: OffsetInputParams.IMPRINT_QUANTITY_PRINTED_BOX_6, value: imprintQuantityPrintedBox6 })
