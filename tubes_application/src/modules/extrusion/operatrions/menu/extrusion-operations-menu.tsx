...
import useExtrusionOperationsMenu from "./use-extrusion-operations-menu";

export default function ExtrusionOperationsMenu({ summaryData }: { summaryData: ISummary | null }) {
  const {
    handleSetClick,
    handleExitClick,
    handleWorkingClick,
  ...
  } = useExtrusionOperationsMenu(summaryData);
