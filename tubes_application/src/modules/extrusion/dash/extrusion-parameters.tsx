...
export default function ExtrusionParameters({ summaryData }: { summaryData: ISummary | null }) {
  ...
  const tubeCilindricalSectionLengthCardProps: ParameterCardProps = {
    ...
    minValue: tresholdsData?.extrusion_tube_cilindrical_section_length_min ?? null,
    maxValue: tresholdsData?.extrusion_tube_cilindrical_section_length_max ?? null,
  ...
  const tubeCilindricalThicknessCardProps: ParameterCardProps = {
    ...
    minValue: tresholdsData?.extrusion_tube_cilindrical_section_thickness_min ?? null,
    maxValue: tresholdsData?.extrusion_tube_cilindrical_section_thickness_max ?? null,
