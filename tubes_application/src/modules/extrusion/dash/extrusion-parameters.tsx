...
export default function ExtrusionParameters({ summaryData }: { summaryData: ISummary | null }) {
  ...
  const tubeCylindricalSectionLengthCardProps: ParameterCardProps = {
    ...
    minValue: tresholdsData?.extrusion_tube_cylindrical_section_length_min ?? null,
    maxValue: tresholdsData?.extrusion_tube_cylindrical_section_length_max ?? null,
  ...
  const tubeCylindricalThicknessCardProps: ParameterCardProps = {
    ...
    minValue: tresholdsData?.extrusion_tube_cylindrical_section_thickness_min ?? null,
    maxValue: tresholdsData?.extrusion_tube_cylindrical_section_thickness_max ?? null,
