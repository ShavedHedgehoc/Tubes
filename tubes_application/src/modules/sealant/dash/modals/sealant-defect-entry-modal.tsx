...
export default function SealantDefectEntryModal() {
  const open = useSealantDefectInputModalStore(
    useShallow((state) => state.open),
  );
  const setOpen = useSealantDefectInputModalStore(
  ...
  const roundData = useSealantDefectStore(
    useShallow((state) => state.roundData),
  );
  const changeData = useSealantDefectStore(
    useShallow((state) => state.changeData),
  );
  const sliceData = useSealantDefectStore(
