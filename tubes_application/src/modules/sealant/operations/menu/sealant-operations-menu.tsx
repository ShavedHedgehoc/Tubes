...
import useSealantOperationsMenu from "./use-sealant-operations-menu";

export default function SealantOperationsMenu({ summaryData }: { summaryData: ISummary | null }) {
  const {
    handleSetClick,
    handleExitClick,
    handleWorkingClick,
  ...
  } = useSealantOperationsMenu(summaryData);
