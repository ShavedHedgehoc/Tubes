...
export default function VarnishDefectEntryModal() {
  const open = useVarnishDefectInputModalStore(
    useShallow((state) => state.open),
  );
  const setOpen = useVarnishDefectInputModalStore(
  ...
  const roundData = useVarnishDefectStore(
    useShallow((state) => state.roundData),
  );
  const changeData = useVarnishDefectStore(
    useShallow((state) => state.changeData),
  );
  const sliceData = useVarnishDefectStore(
