...
export interface AddEntryPageLayoutProps {
  timeComponent: React.ReactNode;
  headerComponent: React.ReactNode;
  entriesComponent: React.ReactNode;
...
export default function AddEntryPageLayout(props: AddEntryPageLayoutProps) {
  return (
