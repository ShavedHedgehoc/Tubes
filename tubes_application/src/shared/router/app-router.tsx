...
const ExtrusionAddEntry = lazy(
  () => import("../../modules/extrusion/extrusion-add-entry"),
);
...
const AppRouter = () => {
  ...
  useCheckHealth();
  if (!isHealthy && init)
    return <NotFound message={AppMessages.SERVER_FALLDOWN} />;
  const router = (
        ...
        <BrowserRouter>
          <Routes>
            <Route
              ...
              element={<RouteSuspense children={<Home />} />}
            />
            <Route
              path={RouteNames.POSTS}
              element={<RouteSuspense children={<Posts />} />}
            />
            <Route
              path={RouteNames.EXTRUSION}
              element={<RouteSuspense children={<Extrusion />} />}
            />
            <Route
            ...
            />
            <Route
              path={RouteNames.EXTRUSION_SOP}
              element={<RouteSuspense children={<ExtrusionSop />} />}
            />
            <Route
              path={RouteNames.VARNISH}
              element={<RouteSuspense children={<Varnish />} />}
            />
            <Route
            ...
            <Route
              ...
              element={<RouteSuspense children={<VarnishOperations />} />}
            />
            <Route
              path={RouteNames.VARNISH_SOP}
              element={<RouteSuspense children={<VarnishSop />} />}
            />
            <Route
              path={RouteNames.OFFSET}
              element={<RouteSuspense children={<Offset />} />}
            />
            <Route
              path={RouteNames.OFFSET_ADD_ENTRY}
            ...
            />
            <Route
              path={RouteNames.OFFSET_SOP}
              element={<RouteSuspense children={<OffsetSop />} />}
            />
            <Route
              path={RouteNames.SEALANT}
              element={<RouteSuspense children={<Sealant />} />}
            />
            <Route
            ...
            <Route
              ...
              element={<RouteSuspense children={<SealantOperations />} />}
            />
            <Route
              path={RouteNames.SEALANT_SOP}
              element={<RouteSuspense children={<SealantSop />} />}
            />
            <Route
              path={RouteNames.SEALANT_PRINT}
              element={<RouteSuspense children={<SealantPrint />} />}
            />
            <Route
              path={RouteNames.PICTURES}
              element={<RouteSuspense children={<Pictures />} />}
            ></Route>
            <Route
              path={RouteNames.NOT_FOUND}
              element={<NotFound message={AppMessages.ROUTE_NOT_FOUND} />}
            />
          </Routes>
        </BrowserRouter>
      </Theme>
